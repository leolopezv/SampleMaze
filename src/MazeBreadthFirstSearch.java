import maze1.Maze;
import searchEngine.BreadthFirstSearchEngine;
...
public class MazeBreadthFirstSearch extends JFrame {
    ...
    BreadthFirstSearchEngine currentSearchEngine = null; //Corregir el nombre de la clase
    ...
    public void paint(Graphics g_unused) {
        ...
        g.drawImage(images[2],6 + goal.width * 29, 3 + goal.height * 29, null);
